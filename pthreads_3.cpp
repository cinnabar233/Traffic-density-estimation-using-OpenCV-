...
vector<double> run_queue_density(VideoCapture cap, Mat img,Mat h)
{
    ...
    cap >> frame ;
    Rect roi(831,211,544,867);
    Rect   roi_left(0,0,181,867);
    Rect   roi_mid(181,0,181,867);
    Rect roi_right(362,0,182,867);
    ...
    while(true)
    {
        ...
        mid_frame = frame_2(roi_mid);

        queue_params *left_half , *right_half,*mid_half;
        queue_params r = {right_frame , right_bg} , l = {left_frame , left_bg}, m={mid_frame , mid_bg};
        ...
        double mid_status= mid_half->area;
        double right_status= right_half->area;
        
        double area = left_status + mid_status+right_status;
